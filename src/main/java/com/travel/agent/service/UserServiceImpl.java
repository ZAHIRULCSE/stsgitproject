...
public class UserServiceImpl implements UserService {
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getFullname(), registrationDto.getEmail(),
				passwordEncoder.encode(registrationDto.getPassword()), Arrays.asList(new Role(Constants.CONTRIBUTOR)));
	...
	public User saveAdmin(User user) {
		User newUser = new User(user.getFullname(), user.getEmail(), passwordEncoder.encode(user.getPassword()),
